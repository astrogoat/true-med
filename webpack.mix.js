...
/*
 ...
 | -----------------------------------------------
 | Using your view with mix('css/true-med.css', 'vendor/true-med')
...
mix
    .postCss('resources/css/true-med.css', 'css', [require('tailwindcss')('tailwind.config.js')])
    .js('resources/js/true-med.js', 'js')
    .version()
